...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
Observe that in the isotropic case the only non-zero $C_j$ are
\begin{equation}
\begin{aligned}
...
\begin{equation}
\begin{aligned}
\widehat{\Gamma}^0_{0,0} &=  N^{0}_{00} \mathring{\widetilde{\xi}}_0^{2} \\
\widehat{\Gamma}^0_{0,1} &=  N^{0}_{01} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1 \\
\widehat{\Gamma}^0_{0,2} &=  N^{0}_{02} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2 \\
\widehat{\Gamma}^0_{0,3} &=  \frac{N^{0}_{00} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{2} + \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_0^{2}}{2} \\
\widehat{\Gamma}^0_{0,4} &=  \frac{N^{0}_{00} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_0^{2}}{2} \\
\widehat{\Gamma}^0_{0,5} &=  \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{2} \\
\widehat{\Gamma}^0_{1,1} &=  N^{0}_{11} \mathring{\widetilde{\xi}}_1^{2} \\
\widehat{\Gamma}^0_{1,2} &=  N^{0}_{12} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2 \\
\widehat{\Gamma}^0_{1,3} &=  \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_1^{2}}{2} + \frac{N^{0}_{11} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{2} \\
\widehat{\Gamma}^0_{1,4} &=  \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{2} \\
\widehat{\Gamma}^0_{1,5} &=  \frac{N^{0}_{11} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_1^{2}}{2} \\
\widehat{\Gamma}^0_{2,2} &=  N^{0}_{22} \mathring{\widetilde{\xi}}_2^{2} \\
\widehat{\Gamma}^0_{2,3} &=  \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{2} \\
\widehat{\Gamma}^0_{2,4} &=  \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_2^{2}}{2} + \frac{N^{0}_{22} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{2} \\
\widehat{\Gamma}^0_{2,5} &=  \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_2^{2}}{2} + \frac{N^{0}_{22} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{2} \\
\widehat{\Gamma}^0_{3,3} &=  \frac{N^{0}_{00} \mathring{\widetilde{\xi}}_1^{2}}{4} + \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{2} + \frac{N^{0}_{11} \mathring{\widetilde{\xi}}_0^{2}}{4} \\
\widehat{\Gamma}^0_{3,4} &=  \frac{N^{0}_{00} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{4} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_0^{2}}{4} \\
\widehat{\Gamma}^0_{3,5} &=  \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_1^{2}}{4} + \frac{N^{0}_{11} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{4} \\
\widehat{\Gamma}^0_{4,4} &=  \frac{N^{0}_{00} \mathring{\widetilde{\xi}}_2^{2}}{4} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{22} \mathring{\widetilde{\xi}}_0^{2}}{4} \\
\widehat{\Gamma}^0_{4,5} &=  \frac{N^{0}_{01} \mathring{\widetilde{\xi}}_2^{2}}{4} + \frac{N^{0}_{02} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_2}{4} + \frac{N^{0}_{22} \mathring{\widetilde{\xi}}_0 \mathring{\widetilde{\xi}}_1}{4} \\
\widehat{\Gamma}^0_{5,5} &=  \frac{N^{0}_{11} \mathring{\widetilde{\xi}}_2^{2}}{4} + \frac{N^{0}_{12} \mathring{\widetilde{\xi}}_1 \mathring{\widetilde{\xi}}_2}{2} + \frac{N^{0}_{22} \mathring{\widetilde{\xi}}_1^{2}}{4}
\end{aligned}
\end{equation}
Finally, compute
\begin{equation}
